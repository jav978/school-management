...
<body>
  ...
  <!-- ============================================================ -->
  <!-- PÁGINA 1: DATOS ALUMNO, PADRES, DOMICILIO E HISTORIAL ESCOLAR -->
  <!-- ============================================================ -->
  <div class="page-container">
    <div class="page-content">
      <table class="header-table">
        <tr>
          ...
          <td class="header-text">
            <div style="font-size:7.5px; font-weight:bold; text-transform:uppercase; line-height:1.2;">
              REPÚBLICA BOLIVARIANA DE VENEZUELA<br>
              MINISTERIO DEL PODER POPULAR PARA LA EDUCACIÓN
            </div>
            <div style="font-size:13px; font-weight:900; margin:1px 0; font-family:serif; letter-spacing:0.5px;">
              U.E. COLEGIO "SANTA LUISA"
            </div>
            <div style="font-size:7.5px; font-weight:bold; color:#222; margin-bottom:2px;">
              R.I.F. J-12345678-9 • Código DEA: S0000D0101
            </div>
            <div style="display:inline-block; padding:1px 8px; border:1px solid #000; border-radius:10px; font-weight:900; font-size:8px; text-transform:uppercase; background:#f9f9f9;">
          ...
          <td class="header-photo">
            <div class="photo-box">
              ${studentPhotoBase64 ? `<img src="${studentPhotoBase64}" alt="Foto Alumno">` : '<div style="padding-top:32px; font-size:6.5px; font-weight:bold; color:#666;">FOTO CARNET<br>ALUMNO<br>(3x4 cm)</div>'}
            </div>
          </td>
        </tr>
      </table>
      ...
      <div class="section-box">
        ...
        <div style="padding: 2.5px;">
          ...
          <table class="parent-card" style="width:100%; border-collapse:collapse;">
            <tr>
              <td style="width: 62px; text-align:center; vertical-align:middle;">
                <div class="rep-photo">
                  ${fatherPhotoBase64 ? `<img src="${fatherPhotoBase64}" alt="Foto Padre">` : '<div style="padding-top:22px; font-size:6px; font-weight:bold; color:#777;">FOTO CARNET<br>PADRE<br>(3x4)</div>'}
                </div>
                <div style="font-size:6.5px; font-weight:900; margin-top:1px;">PADRE</div>
              </td>
          ...
          <table class="parent-card" style="width:100%; border-collapse:collapse;">
            <tr>
              <td style="width: 62px; text-align:center; vertical-align:middle;">
                <div class="rep-photo">
                  ${motherPhotoBase64 ? `<img src="${motherPhotoBase64}" alt="Foto Madre">` : '<div style="padding-top:22px; font-size:6px; font-weight:bold; color:#777;">FOTO CARNET<br>MADRE<br>(3x4)</div>'}
                </div>
                <div style="font-size:6.5px; font-weight:900; margin-top:1px;">MADRE</div>
              </td>
              <td style="padding-left: 5px; vertical-align:top;">
                <table style="width:100%; border-collapse:collapse;">
                  <tr>
          ...
          <table class="parent-card" style="width:100%; border-collapse:collapse; margin-bottom:0;">
            <tr>
              <td style="width: 62px; text-align:center; vertical-align:middle;">
                <div class="rep-photo">
                  ${authPhotoBase64 ? `<img src="${authPhotoBase64}" alt="Foto Autorizado">` : '<div style="padding-top:22px; font-size:6px; font-weight:bold; color:#777;">FOTO CARNET<br>AUTORIZADO<br>(3x4)</div>'}
                </div>
                <div style="font-size:6px; font-weight:900; margin-top:1px;">AUTORIZADO</div>
              </td>
              <td style="padding-left: 5px; vertical-align:top;">
                <table style="width:100%; border-collapse:collapse;">
                  <tr>
      ...
      <!-- SECCIÓN D: PLANTELES DONDE ESTUDIÓ EL ALUMNO (HISTORIAL ESCOLAR) -->
      <div class="section-box">
        <div class="section-title">D. PLANTELES DONDE ESTUDIÓ EL ALUMNO (HISTORIAL ESCOLAR)</div>
        <table class="data-table">
          <thead>
            <tr>
              <th style="width:20%;">GRADO</th>
              <th style="width:20%;">AÑO ESCOLAR</th>
    ...
    <table class="page-footer-table">
      <tr>
        ...
        <td style="text-align:right; font-weight:900; color:#000; letter-spacing:0.5px;">
          PÁGINA 1 DE 2
        </td>
      </tr>
    </table>
  ...
  <div class="page-container page-break">
    <div class="page-content">
      <table class="header-table" style="margin-bottom:3px; padding-bottom:2px;">
        <tr>
      ...
      <div class="section-box">
        <div class="section-title">E. DATOS FAMILIARES, INGRESOS Y NÚCLEO SOCIOECONÓMICO</div>
        <table class="grid-table">
          <tr>
      ...
      <table style="width:100%; border-collapse:collapse; margin-bottom:4px;">
        <tr>
          <!-- I. Requisitos -->
          <td style="width:40%; vertical-align:top; padding-right:2px;">
            <div class="section-box" style="margin-bottom:0;">
          ...
          <td style="width:60%; vertical-align:top; padding-left:2px;">
            <div class="section-box" style="margin-bottom:0;">
      ...
      <table class="signatures-table">
        <tr>
          <td>
            ...
            <div style="font-size:7.5px; font-weight:900; text-transform:uppercase;">FIRMA DEL REPRESENTANTE</div>
            <div style="font-size:6.5px; color:#333;">Nombre: ${v(f.full_name) || v(m.full_name) || '______________________________'}</div>
            <div style="font-size:6.5px; color:#333;">C.I.: ${v(f.national_id) || v(m.national_id) || '____________________'}</div>
          </td>
          <td style="text-align:center;">
            <div class="thumb-box">PULGAR<br>DERECHO</div>
            <div style="font-size:7px; font-weight:bold; margin-top:2px; text-transform:uppercase;">HUELLA DACTILAR</div>
          </td>
          <td>
            <div class="sig-line"></div>
            <div style="font-size:7.5px; font-weight:900; text-transform:uppercase;">DIRECCIÓN / CONTROL DE ESTUDIOS</div>
            <div style="font-size:6.5px; color:#333;">Prof. Graciela Inatty de Poskal</div>
            <div style="font-size:6px; color:#666;">Sello Húmedo del Plantel</div>
          </td>
        </tr>
      </table>
    </div>
