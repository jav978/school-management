    ...
    <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4 print:hidden">
      ...
      <div class="glass-card glass-card-hover rounded-2xl p-5 flex items-center justify-between min-h-[104px]">
        <div class="flex flex-col justify-center">
          ...
          <p class="text-3xl font-black font-display text-slate-900 dark:text-white mt-1 leading-tight tracking-tight">{{ filteredSchedules.length }}</p>
        </div>
        <div class="w-12 h-12 rounded-2xl bg-slate-100 dark:bg-white/5 border border-slate-200 dark:border-white/10 flex items-center justify-center text-slate-500 dark:text-slate-400 flex-shrink-0">
      ...
      <div class="glass-card glass-card-hover rounded-2xl p-5 flex items-center justify-between min-h-[104px]">
        <div class="flex flex-col justify-center">
          ...
          <p class="text-3xl font-black font-display text-slate-900 dark:text-white mt-1 leading-tight tracking-tight">{{ uniqueSubjectsCount }}</p>
        </div>
        <div class="w-12 h-12 rounded-2xl bg-slate-100 dark:bg-white/5 border border-slate-200 dark:border-white/10 flex items-center justify-center text-slate-500 dark:text-slate-400 flex-shrink-0">
          <svg class="w-6 h-6" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="1.8">
      ...
      <div class="glass-card glass-card-hover rounded-2xl p-5 flex items-center justify-between min-h-[104px]">
        <div class="flex flex-col justify-center">
          ...
          <p class="text-3xl font-black font-display text-slate-900 dark:text-white mt-1 leading-tight tracking-tight">{{ uniqueTeachersCount }}</p>
        </div>
        <div class="w-12 h-12 rounded-2xl bg-slate-100 dark:bg-white/5 border border-slate-200 dark:border-white/10 flex items-center justify-center text-slate-500 dark:text-slate-400 flex-shrink-0">
          <svg class="w-6 h-6" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="1.8">
      ...
      <div class="glass-card glass-card-hover rounded-2xl p-5 flex items-center justify-between min-h-[104px]">
        <div class="flex flex-col justify-center">
          ...
          <div class="flex items-baseline gap-2 mt-1">
            <p class="text-3xl font-black font-display text-slate-900 dark:text-white leading-tight tracking-tight">{{ totalAcademicHours }}</p>
                    ...
                    >
                      <div>
                        <div class="flex items-start justify-between gap-1">
                          ...
                          <button
                            ...
                            type="button"
                            class="opacity-0 group-hover:opacity-100 text-rose-500 hover:text-rose-700 p-1 rounded-lg hover:bg-rose-500/10 transition-all print:hidden cursor-pointer"
                      ...
                      <div class="mt-2 pt-1.5 border-t border-black/10 dark:border-white/10 flex items-center justify-between text-[10px] font-bold">
                        ...
                        <button
                          ...
                          type="button"
                          class="opacity-0 group-hover:opacity-100 text-amber-500 hover:text-amber-600 p-1 rounded-lg hover:bg-amber-500/10 transition-all print:hidden cursor-pointer"
