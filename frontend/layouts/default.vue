<template>
  <div class="h-screen w-screen overflow-hidden print:h-auto print:w-auto print:overflow-visible print:bg-white bg-slate-100 dark:bg-[#0c081e] text-slate-800 dark:text-slate-100 flex font-sans transition-colors duration-300">
    ...
    <div 
      ...
      class="fixed inset-0 z-40 bg-slate-900/40 dark:bg-slate-950/80 backdrop-blur-sm lg:hidden transition-opacity duration-300 print:hidden"
    ></div>
