...
const icons = {
  ...
  supplies: createSvgIcon('M9 5H7a2 2 0 00-2 2v12a2 2 0 002 2h10a2 2 0 002-2V7a2 2 0 00-2-2h-2M9 5a2 2 0 002 2h2a2 2 0 002-2M9 5a2 2 0 012-2h2a2 2 0 012 2m-3 7h3m-3 4h3m-6-4h.01M9 16h.01'),
  feedback: createSvgIcon('M11.049 2.927c.3-.921 1.603-.921 1.902 0l1.519 4.674a1 1 0 00.95.69h4.915c.969 0 1.371 1.24.588 1.81l-3.976 2.888a1 1 0 00-.363 1.118l1.518 4.674c.3.922-.755 1.688-1.538 1.118l-3.976-2.888a1 1 0 00-1.176 0l-3.976 2.888c-.783.57-1.838-.197-1.538-1.118l1.518-4.674a1 1 0 00-.363-1.118l-3.976-2.888c-.784-.57-.38-1.81.588-1.81h4.914a1 1 0 00.951-.69l1.519-4.674z'),
  ...
  backup: createSvgIcon('M4 7v10c0 2.21 3.582 4 8 4s8-1.79 8-4V7M4 7c0 2.21 3.582 4 8 4s8-1.79 8-4M4 7c0-2.21 3.582-4 8-4s8 1.79 8 4m0 5c0 2.21-3.582 4-8 4s-8-1.79-8-4'),
...
const allMenuItems = [
  ...
  { path: '/supplies', key: 'supplies', icon: icons.supplies, roles: ['admin', 'control_estudio', 'coordinator', 'teacher', 'student', 'parent'] },
  { path: '/reports', key: 'reports', icon: icons.reports, roles: ['admin', 'control_estudio', 'coordinator', 'teacher'] },
  { path: '/feedback', key: 'feedback', icon: icons.feedback, roles: ['admin', 'control_estudio', 'coordinator'] },
  ...
  { path: '/backups', key: 'backups', icon: icons.backup, roles: ['admin'] },
